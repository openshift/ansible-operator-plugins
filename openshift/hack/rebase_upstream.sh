...
# using the upstream requirements.yml file
cp testdata/memcached-molecule-operator/requirements.yml openshift/release/ansible/requirements.yml
# update ansible_collections directory, abort if there's an error encountered
...
# files, abort if there's an error encountered
